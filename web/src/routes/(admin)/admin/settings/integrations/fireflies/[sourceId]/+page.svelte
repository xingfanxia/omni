...
<svelte:head>
    <title>Configure Fireflies - {data.source.name}</title>
</svelte:head>
            ...
            <Card.Root class="relative">
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            <Card.Title class="flex items-center gap-2">
                                <img src={firefliesLogo} alt="Fireflies" class="h-5 w-5" />
                                {data.source.name}
                            </Card.Title>
                            <Card.Description class="mt-1">
                                Index meeting transcripts, summaries, and action items from
                                Fireflies.ai
                            </Card.Description>
                        </div>
                ...
                <Card.Content>
                    <p class="text-muted-foreground text-sm">
                        All accessible meeting transcripts will be indexed, including summaries,
