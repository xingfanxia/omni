...
<svelte:head>
    <title>Configure GitHub - {data.source.name}</title>
</svelte:head>
            ...
            <Card.Root class="relative">
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <Card.Description class="mt-1">
                                Index repositories, issues, PRs, and discussions from GitHub
                            </Card.Description>
                        </div>
                ...
                <Card.Content>
                    <p class="text-muted-foreground text-sm">
                        All repositories accessible to the connected account will be indexed,
                        including issues, pull requests, and discussions.
                    </p>
                </Card.Content>
